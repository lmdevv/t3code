...
export const DEFAULT_KEYBINDINGS: ReadonlyArray<KeybindingRule> = [
  ...
  { key: "mod+shift+b", command: "preview.toggle" },
  ...
  { key: "mod+alt+f", command: "projectSearch.toggle", when: "!terminalFocus" },
  { key: "mod+alt+t", command: "theme.select", when: "!terminalFocus" },
  ...
  { key: "mod+alt+a", command: "composer.mode", when: "!terminalFocus" },
