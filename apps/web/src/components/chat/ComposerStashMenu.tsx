 ...
 * or configured picker shortcuts, restored with Enter, and dismissed with Escape.
 * The listener runs capture-phase on window so it wins over the Lexical editor's
